    ...
    try {
      ...
      for (const item of items) {
        ...
        processedItems.push({
          ...
          stock: product.stock, // masukkan stock product saat ini untuk di proses update stock product
      ...
      for (const item of processedItems) {
        ...
        await ProductModel.updateStock( // buat method updateStock di productModel
          item.productId,
          item.stock - item.quantity, // ubah product.stock menjadi item.stock dari processedItems, karena product merupakan variable local
        ); // Hanya update stock
      }
